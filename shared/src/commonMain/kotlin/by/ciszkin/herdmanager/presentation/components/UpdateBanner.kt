...
import herdmanager.shared.generated.resources.get_update
import herdmanager.shared.generated.resources.update_available
...
fun UpdateBanner(
    ...
    Card(
        ...
        Row(
            ...
            Text(
                text = stringResource(Res.string.update_available, latestVersion),
